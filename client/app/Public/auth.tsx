import { View, TextInput, TouchableOpacity, Image, Text, ActivityIndicator, SafeAreaView, ScrollView } from 'react-native';
    ...
    <ThemedView>
      <View className='w-full flex-row justify-between items-center pt-8 pb-5 px-2'>
        <View className='flex-row gap-5 items-center justify-center'>
          ...
          <ThemedText type='h2'>Login</ThemedText>
        </View>
      ...
      {/* <ScrollView> */}
      <ThemedView className="dark:bg-slate-900 flex-1">
