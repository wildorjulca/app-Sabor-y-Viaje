/*! @azure/msal-node v3.4.0 2025-03-20 */
'use strict';
'use strict';
...
function addResponseTypeCode(parameters) {
    parameters.set(RESPONSE_TYPE, Constants$1.CODE_RESPONSE_TYPE);
}
/**
 * add response_type = token id_token
 */
function addResponseTypeForTokenAndIdToken(parameters) {
    parameters.set(RESPONSE_TYPE, `${Constants$1.TOKEN_RESPONSE_TYPE} ${Constants$1.ID_TOKEN_RESPONSE_TYPE}`);
}
/**
...
class UsernamePasswordClient extends BaseClient {
    ...
    async createTokenRequestBody(request) {
        ...
        addResponseTypeForTokenAndIdToken(parameters);
